<?php
	...
	if($totalscore >= 1000 AND $totalscore < 3000 AND mysqli_num_rows($bckg3) == 0){
	...
	if($totalscore >= 3000 AND $totalscore < 5000 AND mysqli_num_rows($bckg4) == 0){
	...
	if($totalscore >= 5000 AND $totalscore < 7000 AND mysqli_num_rows($bckg5) == 0){
	...
	if($totalscore >= 7000 AND $totalscore < 9000 AND mysqli_num_rows($bckg6) == 0){
	...
	if($totalscore >= 9000 AND $totalscore < 11000 AND mysqli_num_rows($bckg7) == 0){
	...
	if($totalscore >= 11000 AND $totalscore < 13000 AND mysqli_num_rows($bckg8) == 0){
	...
	if($totalscore >= 13000 AND $totalscore < 15000 AND mysqli_num_rows($bckg9) == 0){
	...
	if($totalscore >= 15000 AND $totalscore < 17000 AND mysqli_num_rows($bckg10) == 0){
	...
	if($row["hs"] >= 150 AND $row["hs"] < 300 AND mysqli_num_rows($snake3) == 0){
	...
	if($row["hs"] >= 300 AND $row["hs"] < 450 AND mysqli_num_rows($snake4) == 0){
	...
	if($row["hs"] >= 450 AND $row["hs"] < 600 AND mysqli_num_rows($snake5) == 0){
	...
	if($row["hs"] >= 600 AND $row["hs"] < 750 AND mysqli_num_rows($snake6) == 0){
	...
	if($row["hs"] >= 750 AND $row["hs"] < 900 AND mysqli_num_rows($snake7) == 0){
	...
	if($row["hs"] >= 900 AND $row["hs"] < 1050 AND mysqli_num_rows($snake8) == 0){
	...
	if($row["hs"] >= 1050 AND $row["hs"] < 1200 AND mysqli_num_rows($snake9) == 0){
	...
	if($row["hs"] >= 1200 AND $row["hs"] < 1350 AND mysqli_num_rows($snake10) == 0){
