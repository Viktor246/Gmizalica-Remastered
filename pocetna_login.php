...
<body>
	...
	<div class="header">
		...
		<div class="side" align="right">
			<a href="profile.php" style="background-color: red;">
			<?php
				if(isset(profile_picture)){
					echo '<img src="data:image/jpeg;base64,'.base64_encode( $row1['profile_picture'] ).'" style="width: 100px;">'
				}
				else{
					echo "<img src="snake1.jpg" style="width: 100px;">"
				}
